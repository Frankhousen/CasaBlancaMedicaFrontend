							...
							<form id="formulariousuario" name="formularioususario" action="" method="get">
								<div id="contenedorprincipal">
									...
									<div class="zonaizquierdo">
										<label for="nombre_archivo">Nombre del Archivo</label>: <input type="text"
											name="nombre_archivo" id="nombre_archivo" size="50" maxlength="50" /> 
											<input type="submit"
										id="botonExaminar" name="botonExaminar" value="Examinar" />
								...
								<div class="zonaderecha">
									<br> <br /> <input type="submit"
										id="botonCargar" name="botonCargar" value="Cargar" />
