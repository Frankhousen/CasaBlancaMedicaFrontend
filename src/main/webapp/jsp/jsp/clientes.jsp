								...
								<div id="contenedorprincipal">
									...
									<div class="zonaizquierdo">
										<label for="cedula">Cédula</label>: <input type="text"
											name="cedula_cliente" id="cedula_cliente" size="20" maxlength="50" /> 
											<label for="telefono:&nbsp">Telefono:</label> <input type="Int"
										name="telefono_cliente" id="telefono_cliente" size="20" maxlength="50" /> <br>
										<label for="nombre Completo">Nombre Completo</label>: <input
											type="text" name="nombre_cliente" id="nombre_cliente" size="20"
											maxlength="50" /> 
											<label for="Correo_Electronico:&nbsp"> Correo Electrónico</label> <input
										type="email" name="email_cliente" id="email_cliente" size="20"
										maxlength="50" /> <br>
											<label
											for="Direccion:&nbsp">Dirección:</label> <input
											type="text" name="direccion_cliente" id="direccion_cliente" size="20" maxlength="50" />
									</div>
								</div>
