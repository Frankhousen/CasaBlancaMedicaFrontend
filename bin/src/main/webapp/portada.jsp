		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">			
				<ul class="nav navbar-nav navbar-right">
					<li><a href="portada.jsp#contactenos" class="smothscroll">Contactenos</a></li>
                    ...
                    <div class="container">
                        <div class="row centered">
                            <div class="col-lg-12">
                                ...
                                <h3>Más de 20 años dedicados a la confección de vestuario
                                    hospitalario y comercialización de equipos médicos.</h3>
                                <br>
                            </div>
                        </div>
                    </div>
